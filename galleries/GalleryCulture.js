...
for (i=0;i<cultureListID.length;i++){
    document.write(
        '<a href="/assets/photo/photo_'+
        cultureListID[i]+'.jpg" data-toggle="lightbox" data-gallery="GalleryCulture" class="display-image">' +
        '<img src="/assets/thumbnails/photo_'+
        cultureListID[i]+'.jpg" class="img-fluid" alt=""></a>'
    );
}
